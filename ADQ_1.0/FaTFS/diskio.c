...
//
// Credits:
//	Credits to ChaN and TivaWare examples. Modified from mmc-dk-tm4c123g.c from TI
//
// Requirements:
// 	Requires Texas Instruments' TivaWare.
//
// Description:
// 	DiskIO functions to be used with TM4C123G
//
// Notes:
//	Specific to SD cards as of right now
//
//
//****************************************************************************************************
...
#define SDC_SSI_TX              GPIO_PIN_5		//GPIO_PIN_5
#define SDC_SSI_RX              GPIO_PIN_4		//GPIO_PIN_4
#define SDC_SSI_FSS             GPIO_PIN_3		//GPIO_PIN_3
#define SDC_SSI_CLK             GPIO_PIN_2		//GPIO_PIN_2
#define SDC_SSI_PINS            (SDC_SSI_TX | SDC_SSI_RX | SDC_SSI_CLK | SDC_SSI_FSS)*/

//CAMBIOS EN LA LIBRERIA------------------------------------------------------->!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#define SDC_SSI_BASE            SSI2_BASE	//SSI0_BASE
#define SDC_SSI_SYSCTL_PERIPH   SYSCTL_PERIPH_SSI2		//SYSCTL_PERIPH_SSI0

// GPIO for SSI pins

//CAMBIOS EN LA LIBRERIA------------------------------------------------------->!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#define SDC_GPIO_PORT_BASE      GPIO_PORTB_BASE	//GPIO_PORTA_BASE
#define SDC_GPIO_SYSCTL_PERIPH  SYSCTL_PERIPH_GPIOB	//SYSCTL_PERIPH_GPIOA
#define SDC_SSI_TX              GPIO_PIN_7		//GPIO_PIN_5
#define SDC_SSI_RX              GPIO_PIN_6		//GPIO_PIN_4
#define SDC_SSI_FSS             GPIO_PIN_5		//GPIO_PIN_3
#define SDC_SSI_CLK             GPIO_PIN_4		//GPIO_PIN_2
#define SDC_SSI_PINS            (SDC_SSI_TX | SDC_SSI_RX | SDC_SSI_CLK | SDC_SSI_FSS)
...
static void send_initial_clock_train(void){
    ...
    /* Send 10 bytes over the SSI. This causes the clock to wiggle the line a required number of times. */
    for(i = 0 ; i < 10 ; i++)
    {
...
static void power_on (void){
     ...
     */
	GPIOPinConfigure(GPIO_PB6_SSI2RX);  	//Señal MISO
	GPIOPinConfigure(GPIO_PB4_SSI2CLK); 	//Señal SCLK
	GPIOPinConfigure(GPIO_PB7_SSI2TX);	//Señal MOSI*/
...
static void set_max_speed(void){
    ...
    SSIConfigSetExpClk(SDC_SSI_BASE, SysCtlClockGet(), SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, i, 8);
